									...
									<div class="toolbar clearfix">
										<div>
											<a href="#" data-target="#forgot-box"
												...
												class="ace-icon fa fa-arrow-left"></i> Change password
											</a>
										</div>
							...
							<div id="forgot-box" class="forgot-box widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<form action="/admin/v1/password" method="POST" id ="changePassword">
											<fieldset>
												<label class="block clearfix"> <span
													...
													class="block input-icon input-icon-right"> <input
														name="password" type="password" class="form-control" placeholder="old password" />
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
												...
												<div class="clearfix">
													...
													<button type="button"
														class="width-65 btn btn-sm btn-success" onclick ="change()">
														<span class="bigger-110">Save</span> <i
